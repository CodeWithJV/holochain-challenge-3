    ...
    match op.flattened::<EntryTypes, LinkTypes>()? {
        ...
        FlatOp::RegisterCreateLink {
            ...
            LinkTypes::AuthorToPosts => {
                validate_create_link_author_to_posts(action, base_address, target_address, tag)
            }
            ...
            LinkTypes::AuthorToComments => {
                validate_create_link_author_to_comments(action, base_address, target_address, tag)
            }
        },
        FlatOp::RegisterDeleteLink {
            ...
            LinkTypes::AuthorToPosts => validate_delete_link_author_to_posts(
                action,
                original_action,
                base_address,
                target_address,
            ...
            LinkTypes::AuthorToComments => validate_delete_link_author_to_comments(
                action,
                original_action,
                base_address,
                target_address,
        ...
        FlatOp::StoreRecord(store_record) => {
            match store_record {
                ...
                OpRecord::CreateLink {
                    ...
                    LinkTypes::AuthorToPosts => validate_create_link_author_to_posts(
                        action,
                        base_address,
                        target_address,
                        tag,
                    ...
                    LinkTypes::AuthorToComments => validate_create_link_author_to_comments(
                        action,
                        base_address,
                        target_address,
                        tag,
